        ...
        <div className="max-w-4xl w-full space-y-12 text-center">
          ...
          <div className="p-8 rounded-[2.5rem] bg-slate-900 text-white flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl mt-8">
            <div className="text-left space-y-2">
              ...
              <p className="text-xs font-medium text-slate-400 leading-relaxed uppercase">At $29/mo, preventing just ONE disenrollment pays for your entire year of MediStay three times over.</p>
            </div>
