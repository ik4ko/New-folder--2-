    ...
    <div className="space-y-16">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="p-8 rounded-[2.5rem] bg-muted/30 border border-border space-y-4">
          ...
          <h4 className="font-black uppercase text-sm tracking-tight">Nightly Snapshot Polls</h4>
          <p className="text-[10px] font-bold text-muted-foreground uppercase leading-relaxed opacity-70">
            We poll carrier data and CMS enrollment snapshots every night at 2:00 AM EST to identify status anomalies across your entire book of business.
          </p>
        </div>
      </section>
      ...
      <div className="p-12 rounded-[3rem] bg-slate-950 text-white space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div className="text-center space-y-2">
            <div className="text-4xl font-black text-primary italic">&lt; 2h</div>
            <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Detection Latency</p>
          </div>
          <div className="text-center space-y-2">
            <div className="text-4xl font-black text-primary italic">AES</div>
