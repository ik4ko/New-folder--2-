              ...
              <div className="flex gap-3">
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Badge variant="outline" className="bg-emerald-500/10 text-emerald-500 border-emerald-500/20 px-4 py-1.5 h-10 gap-2 font-black uppercase tracking-widest cursor-help">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Card className="bg-muted/30 border-none rounded-[2rem] p-6 flex flex-col justify-between min-h-[200px] shadow-sm hover:bg-muted/40 transition-colors cursor-default">
                    <div className="flex justify-between items-start">
                      <span className="text-xs font-black uppercase tracking-widest text-emerald-500">Avg <br />Retention Score</span>
