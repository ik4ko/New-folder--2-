...
import { Search, Filter, MoreHorizontal, UserPlus, FileDown } from "lucide-react"
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-6">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
            ...
            <div className="flex gap-2">
              <Button variant="outline" size="sm" className="flex-1 sm:flex-none rounded-xl h-10 gap-2 border-dashed text-[10px]">
                <Filter className="w-4 h-4 text-primary" /> Carrier
              </Button>
              <Button variant="outline" size="sm" className="flex-1 sm:flex-none rounded-xl h-10 gap-2 border-dashed text-[10px]">
                <Filter className="w-4 h-4 text-primary" /> Risk
              </Button>
            </div>
          </div>
                  ...
                  <TableRow key={member.id} className="hover:bg-primary/5 transition-colors border-border/50">
                    ...
                    <TableCell className="text-right px-6">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <Button variant="outline" size="sm" asChild className="h-8 text-[10px] font-black uppercase tracking-tighter border-primary/20 text-primary hover:bg-primary/5 rounded-lg transition-all px-3">
