...
import { ArrowLeft, Scale, AlertTriangle, CreditCard, Ban, FileText, RefreshCw } from "lucide-react"

export const metadata = { title: "Terms of Service | AegisSage", description: "AegisSage platform terms of service, commitment policies, and usage agreement." }
      ...
      <main className="max-w-3xl mx-auto py-24 px-8 space-y-12">
        <div className="space-y-4">
          ...
          <p className="text-lg font-bold text-muted-foreground uppercase tracking-tight leading-relaxed">
            Legal agreement governing your use of the AegisSage Medicare Retention Platform. Please read carefully before activating your account.
          </p>
        </div>
        ...
        <div className="p-6 rounded-3xl bg-amber-50 border border-amber-200 flex items-start gap-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-amber-700 font-medium">Agency subscriptions are billed on an annual basis and are non-cancellable mid-term. Please review Section 2 and 3 carefully before completing your Agency onboarding.</p>
          </div>
        </div>
        ...
        <div className="p-6 rounded-3xl bg-muted/30 border border-border space-y-3">
          ...
          <div className="flex flex-col gap-1">
            <a href="mailto:legal@aegissage.com" className="font-black text-primary hover:text-primary/80 transition-colors text-sm">legal@aegissage.com</a>
            <a href="mailto:billing@aegissage.com" className="font-black text-primary hover:text-primary/80 transition-colors text-sm">billing@aegissage.com</a>
          </div>
          <p className="text-xs text-muted-foreground font-medium">AegisSage Intelligence Inc. · Governing Law: State of Texas · Venue: Travis County, TX</p>
        </div>
