    ...
    <TooltipProvider delayDuration={0}>
      <div className="w-64 flex flex-col bg-sidebar border-r border-sidebar-border h-full shrink-0 z-50 overflow-hidden">
        ...
        <div className="p-4 mt-auto border-t border-sidebar-border space-y-1">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <div className="mt-4 p-4 rounded-2xl bg-muted/30 border border-border/50 cursor-help">
            ...
            <TooltipContent side="top" className="max-w-[200px]">
              <div className="space-y-1">
                ...
                <p className="text-[10px]">All PII is encrypted with AES-256 at rest and TLS 1.3 in transit.</p>
              </div>
            </TooltipContent>
          </Tooltip>
        </div>
