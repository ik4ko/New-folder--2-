  ...
  return (
    <aside className={cn(
      ...
      <div className="h-20 flex items-center justify-between px-6 border-b border-border shrink-0">
        ...
        <Button variant="ghost" size="icon" asChild className="h-8 w-8 rounded-lg bg-primary/10 text-primary hover:bg-primary hover:text-white transition-all">
      ...
      <div className="p-6 pb-2 shrink-0">
        <div className="relative group">
          ...
          <Input 
            ...
            className="pl-10 h-11 bg-muted/50 border-none rounded-xl text-sm focus-visible:ring-primary shadow-inner text-foreground font-medium"
            value={search}
        ...
        <div className="space-y-1">
          ...
          {filteredMembers.length === 0 && (
            <div className="py-20 text-center">
              <p className="text-xs text-muted-foreground font-bold uppercase tracking-widest opacity-30">No members found.</p>
            </div>
          )}
        </div>
      </ScrollArea>
      ...
      <div className="p-6 border-t border-border bg-muted/5">
        <Button variant="outline" className="w-full justify-center gap-2 h-11 rounded-xl border-border bg-background text-muted-foreground hover:bg-muted font-bold text-xs uppercase tracking-widest transition-all">
